...
| 模块 | 职责 | 关键文件 |
|------|------|----------|
| `docs/dev/` | 开发文档：产品定义、架构、路线图 | `docs/dev/00-readme.md` |
| `docs/wiki/` | 代码描述：模块设计决策 | `docs/wiki/00-readme.md` |
| `docs/usage/` | 使用指南：快速开始、配置、故障排查 | `docs/usage/00-readme.md` |
| `docs/reference/` | 技术参考：详细技术文档 | `docs/reference/00-readme.md` |
| `docs/reference/core/` | Spring 核心基础参考 | `reference/core/ioc-di.md` |
| `docs/reference/database/` | 数据库集成参考 | `reference/database/mysql.md` |
| `docs/reference/framework/` | 框架核心能力参考 | `reference/framework/security-jwt.md` |
| `docs/reference/microservice/` | 微服务架构参考 | `reference/microservice/gateway.md` |
| `docs/reference/advanced/` | 进阶主题参考 | `reference/advanced/webflux.md` |
