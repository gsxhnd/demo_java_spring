...
A: 建议按顺序学习：
1. [reference/core/ioc-di.md](../reference/core/ioc-di.md) → 理解 IoC 容器
2. [reference/core/spring-mvc.md](../reference/core/spring-mvc.md) → 掌握 Web 开发
3. [reference/core/auto-configuration.md](../reference/core/auto-configuration.md) → 理解自动配置
